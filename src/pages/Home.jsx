        ...
        <span style={{ display: 'block' }}>
          ...
          <motion.span
            ...
            style={{ background: 'linear-gradient(90deg,#C9A84C,#f5d78e,#C9A84C,#e8a020)',
              ...
              display: 'inline-block', paddingBottom: '0.12em' }}
      ...
      <div style={{ display: 'flex', gap: isMobile ? 22 : 36 }}>
        {[{v:c1,s:'+',l:'Products'},{v:c2,s:'K+',l:'Customers'},{v:c3,s:'★',l:'Rating'}].map(({v,s,l}) => (
          <div key={l}>
            ...
            <div style={{ fontSize: 9, color: '#94a3b8', marginTop: 4, textTransform: 'uppercase', letterSpacing: '0.1em', fontWeight: 600 }}>{l}</div>
          </div>
        ))}
      </div>
    </div>
          ...
          {QUICK_CATS.map(cat => (
            <motion.button key={cat.slug}
              ...
              style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.09)',
                color: '#cbd5e1', borderRadius: 100, padding: '8px 18px',
